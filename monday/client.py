...
from .resources import ItemResource, UpdateResource, TagResource, BoardResource, UserResource, GroupResource, ComplexityResource, ColumnResource
...
class MondayClient:
    def __init__(self, token):
        ...
        self.columns = ColumnResource(token=token);
